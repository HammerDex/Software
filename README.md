...
## Project Purpose & Development Process Selection
- Selected Model: Waterfall Model
- Reasons for Choosing Waterfall Model
  - Small desktop application with clear, fixed and unchangeable requirements
...
- System Design Phase
  - Tech stack: Python + Tkinter GUI library
  - Interface design: input box, calculation buttons, result display area
- Coding Implementation Phase
  - Write complete interface code
  - Write core calculation logic code
- Testing Phase
...
- Running Method: Directly run calculator.py file
